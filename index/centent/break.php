...
<div class="title">
    <div class="bigBox">
        ...
        <a href="../jion.php" style="text-decoration: none">
            <div class="box2">
                <h4>加入我们</h4>
                <p>欢迎您的加入</p>
            </div>
...
<!--首页导航-->
<div class="texttitle">
    首页 / 家居产品中心 / 北美之家 / <a href="../../type/core.php">空间</a> / SPACE / 课间空间 / 沙发
</div>

<div class="imgBox">
    <div class="leftbox">
        <dl>
            <dt><a href="../../type/core.php">空间SPACE</a></dt>
            <dd>课间空间</dd>
        </dl>
    </div>
    <div class="rightbox">
        <div class="swiper-container">
            <div class="swiper-wrapper">
                <div class="swiper-slide">
                    ...
                    <div class="text">WMA-SDF521沙发椅</div>
                </div>
                <div class="swiper-slide">
                    <div class="img">
                        <img src="../../../static/img/t2.jpg" alt="">
                    </div>
                    <div class="text">192005F15A2D沙发椅</div>
                ...
                <div class="swiper-slide">
                    ...
                    <div class="text">盖博沙发椅</div>
                </div>
                <div class="swiper-slide">
                    <div class="img">
                        <img src="../../../static/img/t4.jpg" alt="">
                    </div>
                    <div class="text">卡普瑞沙发椅</div>
                </div>
                <div class="swiper-slide">
                    <div class="img">
                        <img src="../../../static/img/t5.jpg" alt="">
                    </div>
                    <div class="text">500-1AAs沙发椅</div>
                ...
                <div class="swiper-slide">
                    ...
                    <div class="text">盖博皮单人位</div>
                </div>
                <div class="swiper-slide">
                    <div class="img">
                        <img src="../../../static/img/t7.jpg" alt="">
                    </div>
                    <div class="text">盖博皮脚踏</div>
                </div>
            </div>
        </div>
    </div>
    <!--<div class="rightbox">
        <ul>
            ...
            <li>
                <div class="img">
                    <img src="../../static/imge/t9.jpg" alt="">
                </div>
                <div class="text">沙发椅</div>
            </li>
            <li>
